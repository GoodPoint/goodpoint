...
class TwilioMsg {
	...
	public static function transactionNewPrevOwnerSuccess($barcode_id){ return "Thank you for giving credit where credit is due. You are now the owner of card ".$barcode_id.". Please submit some media to show the good youve been a part of! ".TwilioMsg::transactionAddendum("<LINK>", "<PHONE #>"); }
