...
class TwilioMsg {
	...
	public static function transactionSuccessful($barcode_id){ return "Awesome! You are now the owner of card ".$barcode_id.". Please submit some media to show the good youve been a part of! ".self::transactionAddendum("<LINK>", "<PHONE #>"); }
	...
	public static function transactionNewPrevOwnerSuccess($barcode_id){ return "Thank you for giving credit where credit is due. You are now the owner of card ".$barcode_id.". Please submit some media to show the good youve been a part of! ".self::transactionAddendum("<LINK>", "<PHONE #>"); }
	...
	public static function transactionAddendum($link, $from) { return "You can also go to ".$link." and claim ".$from."s points, and add media to this transaction!"; }
}
