...
class TwilioMsg {
	...
	public static function transactionSuccessful($barcode_id, $link, $phone){ return "You have registered this card successfully! Please go to ".$link." and add media to this transaction! You can also text us some media (pic/video) to show the good youve been a part of!"; }
	...
	public static function transactionNewPrevOwnerSuccess($barcode_id, $link, $phone){ return "You have registered this card successfully! Please go to ".$link." and add media to this transaction! You can also text us some media (pic/video) to show the good youve been a part of! Thank you especially for giving credit where credit was due!"; }
