	...
	class GAPI {	
		public static function urlShorten($sid){
			...
			*/
			...
			$querystring = "?longURL=http%3A%2F%2Fwww.goodpointgame.com%2Fwinwin%2Flaravel%2Fpublic%2Fweb%2Fleaderboard_page.php%3Fsid%3D".$sid."%26first%3Dtrue&apiKey=D638C739-28D4-48B5-9A1F-ECE285DB5B88";
			$client = new Client();
